...
{
    public static class DeleteWatchedStock
    {
  //      [FunctionName("DeleteWatchedStock")]
  //      public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = null)] HttpRequest req,ILogger log)
  //      {
		//	log.LogInformation("DeleteWatchedStock function triggered.");
  ...
  //          // get the portfolio name and symbol
		...
		//		results.ResultObject = gate.DeleteWatchedStock(name, symbol);
		//	}
