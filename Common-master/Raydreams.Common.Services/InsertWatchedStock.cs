...
{
  //  public static class InsertWatchedStock
  //  {
  //      [FunctionName("InsertWatchedStock")]
  //      public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = null)] HttpRequest req,ILogger log)
  //      {
		//	log.LogInformation("InsertWatchedStock function triggered.");
  ...
  //          APIResult<int> results = new APIResult<int>(APIResultType.NoResults);
		...
		//		results.ResultObject = gate.InsertWatchedStock(name, symbol, price);
		//	}
